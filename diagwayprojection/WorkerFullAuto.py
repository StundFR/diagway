...
class WorkerFullAuto(QtCore.QObject):
    ...
    def run(self):
        try:
            ...
            #Get all the values already projected
            for line in csv_lines:
                source_values_done.append(line.split(";")[0])
            source_values_done.pop(0)   #Remove the value from the header
            ...
            #Keep only the values not projected
            ...
            for source_value in  source_values_toDo:
                ...
                #Create the line wich be put in the CSV file
